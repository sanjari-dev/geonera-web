...
export function PredictionDetailsPanel({ selectedPrediction }: PredictionDetailsPanelProps) {
  ...
  return (
    <Card className="shadow-xl h-full grid grid-rows-[auto_1fr]">
          ...
          <ScrollArea className="h-full w-full">
            <div className="space-y-3 pr-2">
              ...
              {selectedPrediction.status === "PENDING" && (
                  <div className="flex items-center space-x-2 text-muted-foreground pt-2 mt-2 border-t border-border">
